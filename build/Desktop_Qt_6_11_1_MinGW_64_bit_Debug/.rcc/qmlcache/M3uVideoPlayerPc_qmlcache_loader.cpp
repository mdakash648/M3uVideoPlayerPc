...
namespace _0x5f_M3uVideoPlayer_src_ui_main_qml { 
...
namespace _0x5f_M3uVideoPlayer_src_ui_components_Sidebar_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _0x5f_M3uVideoPlayer_src_ui_components_SidebarButton_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_M3uVideoPlayerPc)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_M3uVideoPlayerPc))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_M3uVideoPlayerPc)() {
    return 1;
}
